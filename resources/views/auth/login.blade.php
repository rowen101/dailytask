    ...
    <div class="container-fluid">
        <div class="row h-100">
            <div class="login-left-content">
                <div style="background-image: url('https://wallpaperaccess.com/full/2308901.jpg');background-repeat: no-repeat;background-size: auto;" class="col-sm-8 col-2 h-100  text-white py-2 d-flex align-items-center justify-content-center fixed-top"
                    id="left">
